...
- Examples
  ...
  - smiile
- Overview
  - find idea (already working, not new)
  - Team: frontend dev, backend dev, UI/UX designer, overseer (4 members 25% each)
  - Scale to $10K MRR ( $2.5K should cover 4 members)
- Playbook
  1. Used Idea [yt](https://youtu.be/67zh8_yiPh4?t=361)
  2. Good enough MVP [yt](https://youtu.be/67zh8_yiPh4?t=373)
  3. LTD Lifetime deals [yt](https://youtu.be/67zh8_yiPh4?t=389)
  4. Always charge [yt](https://youtu.be/67zh8_yiPh4?t=398)
  5. Maximizse LTD sales [yt](https://youtu.be/67zh8_yiPh4?t=415)
  6. Write content [yt](https://youtu.be/67zh8_yiPh4?t=438)
  7. Launch on a marketplace like APPSUMO Close LTD with 100K aka angel fund [yt](https://youtu.be/67zh8_yiPh4?t=463) 
  8. Final private LTD [yt](https://youtu.be/67zh8_yiPh4?t=501)
  9. Customer reviews [yt](https://youtu.be/67zh8_yiPh4?t=531)
  10. Find customers on Reddit / Quora [yt](https://youtu.be/67zh8_yiPh4?t=556)
- Tech Stack [yt](https://youtu.be/67zh8_yiPh4?t=716)
  - frontend: vue.js or react.dev
  - backend: laravel.com (php)
  - voice typing: willowvoice.com
  - notes: granola.ai
  - message: slack.com
...
# Brian notes
- tbd new
- [https://th-twig.2cld.net/](https://th-twig.2cld.net/)
...
- block house [yt](https://www.youtube.com/watch?v=ZHUeOW9wsr0)
- construction bot [yt](https://youtu.be/ba_PGyKsi2o?t=35)
- tbd
